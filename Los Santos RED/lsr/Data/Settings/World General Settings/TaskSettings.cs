...
public class TaskSettings : ISettingsDefaultable
{
    ...
    [Description("Minimum payment amount for the Contractor task from Contractor")]
    public int ContractorPaymentMin { get; set; }
    [Description("Maximum payment amount for the Contractor task from Contractor")]
    public int ContractorPaymentMax { get; set; }
    [Description("Complications Percent for the Contractor task from Contractor")]
    public float ContractorComplicationsPercentage { get; set; }
    ...
    public void SetDefault()
    {
        ...
        ContractorPaymentMin = 1500;// 10000;
        ContractorPaymentMax = 2500;// 20000;
        ContractorComplicationsPercentage = 45f;
