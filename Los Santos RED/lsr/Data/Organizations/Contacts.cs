...
public class Contacts : IContacts
{
    ...
    private void DefaultConfig()
    {
        ...
        PossibleContacts.ContractorContact.Add(ContractorContact);
    ...
    private void DefaultConfig_FullExpanded()
    {
        ...
        PossibleContacts_FullExpanded.ContractorContact.Add(ContractorContact);
    ...
    private void DefaultConfig_LC()
    {
        ...
        PossibleContacts_LC.ContractorContact.Add(ContractorContact);
        ...
        PossibleContacts_LCPP.ContractorContact.Add(ContractorContact);
